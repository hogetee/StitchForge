...
class LayerWorkflow:
    def segmentation_controls(self):
        ...
        self.single_material=QCheckBox('One material silhouette (recommended)')
        self.single_material.setChecked(True)
        self.single_material.setToolTip('Use one non-dark foreground layer and keep dark details separate. Turn this off to retain separate material colors.')
